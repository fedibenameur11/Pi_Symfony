...
class CategorieController extends AbstractController
{
    ...
    public function new(Request $request, CategorieRepository $categorieRepository,SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $brochureFile = $form->get('imageC')->getData();
...
#[Route('/front/cat', name: 'app_categorie_indexF', methods: ['GET'])]
    public function indexf(CategorieRepository $categorieRepository): Response
    {
        return $this->render('categorie/CatH.html.twig', [
            'categories' => $categorieRepository->findAll(),
        ]);
